...
# EDA Questions
# Q1.	What percentage of EVs in Washington are Tesla?
...
# Q2.	Top Tesla Models selling in the area. 
...
# Q3.	Tesla vs. Competitors - Range and MSRP. 
#  -  AVG and Median
...
# Q4.	PHEV vs BEV Trends

bhev_vs_bev <- clean_df %>%
  group_by(Model_Year, Electric_Vehicle_Type) %>%
  summarise(Count = n(), .groups = "drop")

# Q5. Top Electric Utilities in Washington for Tesla
